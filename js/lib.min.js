...
(function (window, document, undefined) {
    ...
    function minErr(module, ErrorConstructor) {
        ...
        return function () {
            ...
            message += "\nhttp://errors.angularjs.org/1.4.0-beta.6/" + (module ? module + "/" : "") + code;
    ...
    var version = {full: "1.4.0-beta.6", major: 1, minor: 4, dot: 0, codeName: "cookie-liberation"};
    ...
    function $LocationProvider() {
        var hashPrefix = "", html5Mode = {enabled: false, requireBase: true, rewriteLinks: true};
    ...
    function $ParseProvider() {
        ...
        this.$get = ["$filter", "$sniffer", function ($filter, $sniffer) {
            ...
            }, $parseOptionsExpensive = {csp: $sniffer.csp, expensiveChecks: true};
    ...
    var ngBindDirective = ["$compile", function ($compile) {
        return {
            restrict: "AC", compile: function ngBindCompile(templateElement) {
    ...
    var ngBindHtmlDirective = ["$sce", "$parse", "$compile", function ($sce, $parse, $compile) {
        return {
            restrict: "A", compile: function ngBindHtmlCompile(tElement, tAttrs) {
        ...
        function parseOptionsExpression(optionsExp, selectElement, scope) {
            ...
            return {
                getWatchables: $parse(valuesFn, function (values) {
                    ...
                    return {
                        items: optionItems, selectValueMap: selectValueMap, getOptionFromViewValue: function (value) {
    ...
    var ngSwitchDirective = ["$animate", function ($animate) {
        return {
            require: "ngSwitch", controller: ["$scope", function ngSwitchController() {
                this.cases = {}
